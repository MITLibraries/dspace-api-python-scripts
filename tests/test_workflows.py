...
def test_append_items_to_coll(client, json_metadata_delim, input_dir):
    """Test append_items_to_col function."""
    items = workflows.append_items_to_coll(client, '333.3333', 'local',
                                           input_dir, 'pdf',
                                           json_metadata_delim, 'True', {})
